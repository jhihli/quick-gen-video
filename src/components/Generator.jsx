  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className={`flex-grow ${
        isMobile ? 'h-full' : 'max-w-7xl mx-auto py-8 sm:px-6 lg:px-8'
      }`}>
        <div className={isMobile ? 'h-full py-4' : 'px-4 py-6 sm:px-0'}>
          {/* Mobile Carousel */}
          {isMobile ? (
            <div className="relative w-full h-full flex flex-col">
              {/* Progress Indicator */}
              <div className="flex justify-center mb-6 space-x-3 px-4">
              ...
              <div className="flex-1 overflow-hidden relative">
                ...
                >
                    {steps.map((step, index) => (
                      ...
                      >
                        <motion.div
                          className={`relative overflow-hidden backdrop-blur-xl border rounded-2xl shadow-2xl transition-all duration-300 h-full mx-4 ${
                          step.color === 'cyan'
                          ...
                          style={{
                            height: `${Math.min(viewportWidth * 1.2, 600)}px`,
                            minHeight: '450px'
                          }}
                          animate={{
                        ...
                        <div className="absolute inset-0 opacity-20">
                          <motion.div
                            className={`absolute top-0 left-0 w-24 h-24 rounded-full blur-xl ${
                              step.color === 'cyan'
                                ? 'bg-cyan-400/30'
                                : step.color === 'purple'
                                ? 'bg-purple-400/30'
                          ...
                          <div className="relative z-10 p-4 h-full flex flex-col">
                            {/* Drag Handle */}
                            <div className="absolute top-2 left-1/2 transform -translate-x-1/2 w-12 h-1 bg-white/30 rounded-full cursor-grab active:cursor-grabbing hover:bg-white/50 transition-colors"></div>
                            ...
                            <div className="mb-4 flex-shrink-0 mt-4">
                              <AnimatedTitle
                                ...
                                delay={0.3}
                                icon={<step.icon size={6} className={`${
                                  step.color === 'cyan'
                                    ? 'text-cyan-400'
                                    : step.color === 'purple'
                                    ? 'text-purple-400'
              ...
              <div className="flex justify-between items-center mt-6 px-4 flex-shrink-0">
                <motion.button
                ...
                <motion.button
                  ...
                  whileTap={currentStep < steps.length - 1 ? { scale: 0.9 } : {}}
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
